    ...
    <section className="bg-white py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-8 text-center">
        ...
        <div className="max-w-4xl mx-auto mb-8 relative">
          ...
          />
          <button className="absolute right-2 top-2 h-[32px] w-[32px] md:h-[44px] md:w-[44px] bg-primary text-white rounded-[4px] flex items-center justify-center hover:bg-primary-hover transition-colors">
            <svg
