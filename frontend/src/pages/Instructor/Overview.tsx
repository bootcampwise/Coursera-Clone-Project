  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="pb-6 border-b border-gray-200">
        <h1 className="text-2xl font-semibold text-gray-900 mb-2">Instructor Overview</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((s) => (
          <div key={s.label} className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5">
            <div className="flex items-start justify-between mb-4">
              <div className="p-2.5 rounded-lg bg-blue-50 text-blue-600">{s.icon}</div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Keep your course launches clean and consistent.</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { title: "Course metadata", desc: "Title, description, outcomes, category." },
              { title: "Curriculum", desc: "Modules and lessons structure." },
              { title: "Videos", desc: "Upload and link lesson videos." },
              { title: "Pricing & publish", desc: "Set price, preview, publish." },
            ].map((item) => (
              <div key={item.title} className="p-4 rounded-lg border border-gray-200 bg-gray-50">
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-500">Latest course events and updates.</p>
          </div>
          <div className="space-y-4 max-h-[320px] overflow-y-auto custom-scrollbar pr-2">
            {[
              { label: "New enrollment", detail: "React Fundamentals", time: "3m ago" },
              { label: "Video uploaded", detail: "Lesson 2 • Routing", time: "1h ago" },
              { label: "Review received", detail: "Course rating 5.0", time: "5h ago" },
              { label: "Draft updated", detail: "AI for Beginners", time: "1d ago" },
            ].map((a, idx) => (
