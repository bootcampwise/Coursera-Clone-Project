  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="pb-6 border-b border-gray-200">
        ...
        <p className="text-sm text-gray-500">Track enrollments, watch-time, and performance across courses.</p>
      </div>
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Connect analytics API to render charts.</p>
            </div>
          ...
          <div className="h-[320px] bg-gradient-to-br from-blue-50 to-gray-50 rounded-lg border-2 border-dashed border-gray-200 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm font-medium text-gray-600">Analytics charts</p>
              <p className="text-xs text-gray-400 mt-1">Enrollments, watch-time, retention</p>
            </div>
          </div>
        </div>

        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          <h2 className="text-lg font-semibold text-gray-900 mb-2">Quick Insights</h2>
          <p className="text-sm text-gray-500">High-signal KPIs for creators.</p>

          <div className="mt-5 space-y-3">
            {[
              { label: "Top course", value: "React Fundamentals" },
              { label: "Completion rate", value: "62%" },
              { label: "Avg watch-time", value: "11.4m" },
              { label: "Refund rate", value: "1.2%" },
            ].map((k) => (
              <div key={k.label} className="p-4 rounded-lg bg-gray-50 border border-gray-200">
                <div className="text-xs text-gray-500">{k.label}</div>
                <div className="text-sm font-semibold text-gray-900 mt-1">{k.value}</div>
              </div>
            ))}
          </div>
        </div>
