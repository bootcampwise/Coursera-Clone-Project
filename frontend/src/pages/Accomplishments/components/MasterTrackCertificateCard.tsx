...
const MasterTrackCertificateCard: React.FC<MasterTrackCertificateCardProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-white border border-[#e3e6ef] rounded-[10px] overflow-hidden shadow-[0_1px_3px_rgba(0,0,0,0.08)]">
      ...
      <div className="pt-3 pb-3 ml-3 flex flex-col flex-1">
        ...
        <h3 className="text-[14px] font-normal text-[#0F102F] mb-3 line-clamp-2 leading-[1.3] min-h-[40px]">
          {title}
        </h3>

        <div className="mt-auto">
          <div className="flex items-center gap-1.5 text-[#0663D6] text-[12px] font-normal mb-2">
            <img
