...
const Overview: React.FC = () => {
  ...
  const activities: Activity[] = [
    { user: "Sarah Johnson", action: "enrolled in", target: "React Security Course", time: "2 minutes ago" },
    { user: "Michael Rodriguez", action: "completed", target: "UX Design Module", time: "15 minutes ago" },
    { user: "Anna Kim", action: "logged in from", target: "London, UK", time: "1 hour ago" },
    { user: "David Lee", action: "added new", target: "Content Module", time: "3 hours ago" },
    { user: "Emma Wilson", action: "submitted review for", target: "JavaScript Basics", time: "5 hours ago" },
  ];
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className={`p-2.5 rounded-lg ${
                stat.isPositive ? "bg-blue-50 text-blue-600" : "bg-gray-50 text-gray-600"
              }`}>
                {stat.icon}
              </div>
              <span
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-lg font-semibold text-gray-900">Growth Analytics</h2>
              <p className="text-sm text-gray-500 mt-1">Platform growth over time</p>
            </div>
          ...
          <div className="h-[320px] bg-gradient-to-br from-blue-50 to-gray-50 rounded-lg border-2 border-dashed border-gray-200 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-xs text-gray-400 mt-1">Connect analytics API to display data</p>
            </div>
          </div>
        </div>
